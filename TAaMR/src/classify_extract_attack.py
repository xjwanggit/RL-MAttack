...
def parse_args():
    ...
    parser.add_argument('--origin_class', type=int, default=806)  # 原类型是'analog clock'409
    parser.add_argument('--target_class', type=int, default=773)  # 目标类型是'digital clock',530
    ...
    parser.add_argument('--eps', type=float, default=16)   # 扰动大小
